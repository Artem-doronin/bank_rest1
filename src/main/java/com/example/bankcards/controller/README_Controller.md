...
Описание задачи
Создание и управление картами Просмотр карт Переводы между своими картами 
Атрибуты карты
Номер карты (зашифрован, отображается маской: **** **** **** 1234),Владелец ,Срок действия
...
Безопасность
Шифрование данных
Ролевой доступМаскирование номеров карт
Работа с БД
...
Технологии
Java 17+, Spring Boot, Spring Security, Spring Data JPA, PostgreSQL/MySQL, Liquibase,
Docker, JWT, Swagger (OpenAPI) создай проект